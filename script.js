...
function generateEscapeRooms() {
    ...
    room.addAction({type: 'encounter', parameters: [{
        enemies: [
            new Enemy('Blatto Lackey 1', 20, 10, 5, `A tall, lanky fellow. All brain, no brawn.`),
            new Enemy('Palmetto', 40, 15, 15, `A rootin', tootin', mutant shootin' cockroach. No...a glockroach.`),
            new Enemy('Blatto Lackey 2', 20, 5, 10, `A short, dumpy fellow. All brawn, no brain.`),
        ],
        rewards: [
